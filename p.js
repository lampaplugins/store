(function () {
    ...
    function vka16start() { // Аниме
        ...
        var item = $('<li class="menu__item selector" data-action="anime"><div class="menu__ico">' + iconm + '</div><div class="menu__text">Anime</div></li>'); // data-action ИЗМЕНЕНО (было mult3)
