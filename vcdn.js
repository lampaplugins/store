...
var randomUrl = vybor[randomIndex];
  ...
  function startPlugin() {
    ...
    Lampa.Lang.add({
      ...
      lampac_balanser_dont_works: { //
        ru: 'Доступно в полной версии Onlyskaz',
        uk: 'Доступно в полной версии Onlyskaz',
        en: 'Only full version Onlyskaz',
        zh: 'Only full version Onlyskaz'
      },
